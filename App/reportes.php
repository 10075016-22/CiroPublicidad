      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <div class="col-md-12">
            <h2>REPORTES</h2>
            <br>
            <a href="report.php" target="_blank" class="btn btn-info btn-sm">Reporte total</a>
          </div>
          ...
          <tbody id="tabla">
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <form action="reportSingle.php" method="GET">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <button type="submit" class="btn btn-danger btn-sm"><i class="fa fa-print"></i> Detalles</button>
                  </form>
                </td>
               <?php } ?>
            </tbody>
